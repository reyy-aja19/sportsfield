...
<form class="form-card profile-card"
      method="POST"
    ...
    <div class="profile-top">
        <div class="profile-photo preview-shell has-image">
            ...
            <img id="admin-photo-preview"
                 src="{{ $profile?->profile_photo ? asset($profile->profile_photo) : $fallbackAdminPhoto }}"
                 alt="{{ $adminName }}">
        ...
        <div class="muted" style="margin-top:4px;">
            Foto admin bisa diganti langsung dari panel ini.
        </div>
    </div>

    <div class="form-group">
        <label>Foto Admin</label>
        <input class="input-ui"
               name="profile_photo"
               type="file"
               accept="image/*"
               data-preview="admin-photo-preview">
    </div>
