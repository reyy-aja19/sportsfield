...
<div class="review-card wide">
    ...
    <div class="stars">
       {{ str_repeat('★', min(5, (int)$review->rating)) }}
    </div>
</div>
    ...
    <form method="POST" action="{{ route('admin.reviews.reply', $review) }}" class="mt-12">@csrf<div class="btn-row stretch"><input
    class="input-ui"
    name="reply_message"
    placeholder="Tulis balasan admin"
    required><button class="btn-ui btn-green">Simpan Balasan</button></div></form>
